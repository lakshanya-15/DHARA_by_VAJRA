      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
        ...
        <div className="lg:col-span-2 space-y-10">
            <div className="flex justify-between items-center pb-6 border-b border-slate-200">
                <div>
                   <h2 className="text-2xl font-bold text-slate-900 mb-1">{asset.type} operated by Professional</h2>
                   <p className="text-sm text-slate-500 font-medium">Standard Capacity · Maintained Regularly · Ready for Field</p>
                </div>
            ...
            <div className="space-y-6 pb-6 border-b border-slate-200">
                <div className="flex gap-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-slate-900">Platform Protected</h4>
                        <p className="text-slate-500 text-sm mt-1">Every booking is protected by DHARA's trust and safety guarantee. We cover machine damage up to ₹50,000.</p>
                    </div>
                </div>
                <div className="flex gap-4">
            ...
            <div className="space-y-4 pb-6 border-b border-slate-200">
                ...
                <p className="text-slate-600 leading-relaxed font-medium whitespace-pre-wrap">
                    {asset.description || "This machine is well-maintained and ready to handle tough field conditions. Equipped with standard modern features and operated by a vetted professional operator representing our local network.\n\nPerfect for your heavy-duty agricultural needs. Reach out via the platform if you need specific implements attached."}
                </p>
            </div>
        ...
        <div className="w-full relative">
            <div className="sticky top-28 bg-white border border-slate-200 rounded-3xl p-6 shadow-xl shadow-slate-200/50">
                ...
                <button 
                    ...
                    `}
                >
                    {success ? 'Reserved!' : (isBooking ? 'Processing...' : (asset.availability ? 'Reserve' : 'Unavailable'))}
                </button>
